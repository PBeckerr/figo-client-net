...
namespace Figo.Client.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public class Securities : IEquatable<Securities>, IValidatableObject
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="Securities" /> class.
        /// </summary>
        /// <param name="deleted">List of security IDs marked as deleted..</param>
        /// <param name="securities">List of securities..</param>
        /// <param name="status">status.</param>
        public Securities(List<string> deleted = default, List<Security> securities = default, AccountStatus status = default)
        {
        ...
        /// <summary>
        ///     List of security IDs marked as deleted.
        /// </summary>
        /// <value>List of security IDs marked as deleted.</value>
        ...
        public List<Security> _Securities { get; set; }
        ...
        /// <summary>
        ///     Returns true if Securities instances are equal
        /// </summary>
        /// <param name="input">Instance of Securities to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Securities input)
        {
            if (input == null)
            {
                return false;
            ...
            return
                (
                    ...
                    this.Deleted != null &&
                    input.Deleted != null &&
                    this.Deleted.SequenceEqual(input.Deleted)
                ) &&
                (
                    this._Securities == input._Securities ||
                    this._Securities != null &&
                    input._Securities != null &&
                    this._Securities.SequenceEqual(input._Securities)
                ) &&
                (
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Securities {\n");
            sb.Append("  Deleted: ").Append(this.Deleted).Append("\n");
            sb.Append("  _Securities: ").Append(this._Securities).Append("\n");
        ...
        {
            return this.Equals(input as Securities);
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = hashCode * 59 + this._Securities.GetHashCode();
                }
