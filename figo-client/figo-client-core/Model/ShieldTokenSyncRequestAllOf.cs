...
{
    /// <summary>
    ///     ShieldTokenSyncRequestAllOf
    /// </summary>
    [DataContract]
    public class ShieldTokenSyncRequestAllOf : IEquatable<ShieldTokenSyncRequestAllOf>, IValidatableObject
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="ShieldTokenSyncRequestAllOf" /> class.
        /// </summary>
        [JsonConstructor]
        protected ShieldTokenSyncRequestAllOf()
        {
        }
        ...
        public ShieldTokenSyncRequestAllOf(List<string> accounts = default)
        {
            this.Accounts = accounts ?? throw new InvalidDataException("accounts is a required property for ShieldTokenSyncRequestAllOf and cannot be null");
        }
        ...
        /// <summary>
        ///     Returns true if ShieldTokenSyncRequestAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ShieldTokenSyncRequestAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShieldTokenSyncRequestAllOf input)
        {
            if (input == null)
            {
                return false;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShieldTokenSyncRequestAllOf {\n");
        ...
        {
            return this.Equals(input as ShieldTokenSyncRequestAllOf);
        }
