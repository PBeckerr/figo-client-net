...
namespace Figo.Client.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public class StandingOrdersResponse : IEquatable<StandingOrdersResponse>, IValidatableObject
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="StandingOrdersResponse" /> class.
        /// </summary>
        /// <param name="status">status.</param>
        /// <param name="standingOrders">standingOrders.</param>
        public StandingOrdersResponse(Status status = default, List<StandingOrder> standingOrders = default)
        {
            this.Status = status;
        ...
        /// <summary>
        ///     Gets or Sets StandingOrders
        /// </summary>
        [DataMember(Name = "standing_orders", EmitDefaultValue = false)]
        public List<StandingOrder> StandingOrders { get; set; }

        /// <summary>
        ///     Returns true if StandingOrdersResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of StandingOrdersResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StandingOrdersResponse input)
        {
            if (input == null)
            {
                return false;
            ...
            return
                ...
                (
                    this.StandingOrders == input.StandingOrders ||
                    this.StandingOrders != null &&
                    input.StandingOrders != null &&
                    this.StandingOrders.SequenceEqual(input.StandingOrders)
                );
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StandingOrdersResponse {\n");
            sb.Append("  Status: ").Append(this.Status).Append("\n");
            sb.Append("  StandingOrders: ").Append(this.StandingOrders).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as StandingOrdersResponse);
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = hashCode * 59 + this.StandingOrders.GetHashCode();
                }
