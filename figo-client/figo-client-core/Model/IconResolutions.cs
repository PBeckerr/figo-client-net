...
namespace Figo.Client.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public class IconResolutions : IEquatable<IconResolutions>, IValidatableObject
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="IconResolutions" /> class.
        /// </summary>
        ...
        public IconResolutions(string _48x48 = default, string _60x60 = default, string _72x72 = default, string _84x84 = default, string _96x96 = default,
        ...
        /// <summary>
        ///     Returns true if IconResolutions instances are equal
        /// </summary>
        /// <param name="input">Instance of IconResolutions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IconResolutions input)
        {
            if (input == null)
            {
                return false;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IconResolutions {\n");
        ...
        {
            return this.Equals(input as IconResolutions);
        }
