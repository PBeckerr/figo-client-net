...
namespace Figo.Client.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public class ShieldToken : IEquatable<ShieldToken>, IValidatableObject
    {
        /// <summary>
        ///     The requested RegShield access scope.
        /// </summary>
        /// <value>The requested RegShield access scope.</value>
        ...
        public enum ScopeEnum
        {
            ...
            /// </summary>
            [EnumMember(Value = "ais")] Ais = 1,

            /// <summary>
            ///     Enum Aisplus for value: ais_plus
            /// </summary>
            [EnumMember(Value = "ais_plus")] Aisplus = 2,

            /// <summary>
            ///     Enum Pis for value: pis
            /// </summary>
            [EnumMember(Value = "pis")] Pis = 3,

            /// <summary>
            ///     Enum Pisplus for value: pis_plus
            /// </summary>
            [EnumMember(Value = "pis_plus")] Pisplus = 4
        }
        ...
        /// <summary>
        ///     The RegShield system issuing this ShieldToken. See [issuer
        ///     claim](https://tools.ietf.org/html/rfc7519#section-4.1.1)
        /// </summary>
        /// <value>
        ///     The RegShield system issuing this ShieldToken. See [issuer
        ///     claim](https://tools.ietf.org/html/rfc7519#section-4.1.1)
        ...
        /// <summary>
        ///     Client-ID which requested this ShieldToken. See [subject claim](https://tools.ietf.org/html/rfc7519#section-4.1.2)
        /// </summary>
        /// <value>
        ///     Client-ID which requested this ShieldToken. See [subject
        ///     claim](https://tools.ietf.org/html/rfc7519#section-4.1.2)
        /// </value>
        [DataMember(Name = "sub", EmitDefaultValue = false)]
        public string Sub { get; set; }

        /// <summary>
        ///     The intended audience (RegGUI client-ID). See [audience claim](https://tools.ietf.org/html/rfc7519#section-4.1.3)
        /// </summary>
        /// <value>
        ///     The intended audience (RegGUI client-ID). See [audience
        ...
        /// <summary>
        ///     The expiration time of the token as epoch time. See [expiration time
        ///     claim](https://tools.ietf.org/html/rfc7519#section-4.1.4)
        /// </summary>
        /// <value>
        ///     The expiration time of the token as epoch time. See [expiration time
        ///     claim](https://tools.ietf.org/html/rfc7519#section-4.1.4)
        ...
        ///     Unique identifier of the ShieldToken. See [JWT ID](https://tools.ietf.org/html/rfc7519#section-4.1.7)
        /// </summary>
        /// <value>Unique identifier of the ShieldToken. See [JWT ID](https://tools.ietf.org/html/rfc7519#section-4.1.7)</value>
        ...
        /// </summary>
        /// <value>The name associated with the client.</value>
        [DataMember(Name = "sub_name", EmitDefaultValue = false)]
        public string SubName { get; set; }

        /// <summary>
        ///     The state included in the request.
        /// </summary>
        /// <value>The state included in the request.</value>
        [DataMember(Name = "state", EmitDefaultValue = false)]
        public string State { get; set; }

        /// <summary>
        ///     The redirect endpoint URL included in the request.
        /// </summary>
        /// <value>The redirect endpoint URL included in the request.</value>
        [DataMember(Name = "redirect_uri", EmitDefaultValue = false)]
        public string RedirectUri { get; set; }

        /// <summary>
        ///     Returns true if ShieldToken instances are equal
        /// </summary>
        /// <param name="input">Instance of ShieldToken to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShieldToken input)
        {
            if (input == null)
            {
                return false;
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SubName: ").Append(this.SubName).Append("\n");
        ...
        {
            return this.Equals(input as ShieldToken);
        }
