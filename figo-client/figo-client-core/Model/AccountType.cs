...
namespace Figo.Client.Core.Model
{
    ...
    {
        /// <summary>
        ///     Enum Giroaccount for value: Giro account
        /// </summary>
        [EnumMember(Value = "Giro account")] Giroaccount = 1,

        /// <summary>
        ///     Enum Savingsaccount for value: Savings account
        /// </summary>
        [EnumMember(Value = "Savings account")]
        Savingsaccount = 2,

        /// <summary>
        ///     Enum Dailysavingsaccount for value: Daily savings account
        /// </summary>
        [EnumMember(Value = "Daily savings account")]
        Dailysavingsaccount = 3,

        /// <summary>
        ///     Enum Creditcard for value: Credit card
        /// </summary>
        [EnumMember(Value = "Credit card")] Creditcard = 4,

        /// <summary>
        ///     Enum Loanaccount for value: Loan account
        /// </summary>
        [EnumMember(Value = "Loan account")] Loanaccount = 5,

        /// <summary>
        ///     Enum PayPal for value: PayPal
        /// </summary>
        [EnumMember(Value = "PayPal")] PayPal = 6,

        /// <summary>
        ///     Enum Depot for value: Depot
        /// </summary>
        [EnumMember(Value = "Depot")] Depot = 7,
