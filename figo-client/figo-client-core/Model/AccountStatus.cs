...
namespace Figo.Client.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public class AccountStatus : IEquatable<AccountStatus>, IValidatableObject
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="AccountStatus" /> class.
        /// </summary>
        /// <param name="message">Human-readable message of the last sync error..</param>
        /// <param name="syncTimestamp">Timestamp of last synchronization..</param>
        /// <param name="successTimestamp">Timestamp of last successful synchronization..</param>
        public AccountStatus(string message = default, string syncTimestamp = default, string successTimestamp = default)
        {
        ...
        /// <summary>
        ///     Human-readable message of the last sync error.
        /// </summary>
        /// <value>Human-readable message of the last sync error.</value>
        ...
        /// </summary>
        /// <value>Timestamp of last synchronization.</value>
        [DataMember(Name = "sync_timestamp", EmitDefaultValue = false)]
        public string SyncTimestamp { get; set; }

        /// <summary>
        ///     Timestamp of last successful synchronization.
        /// </summary>
        /// <value>Timestamp of last successful synchronization.</value>
        [DataMember(Name = "success_timestamp", EmitDefaultValue = false)]
        public string SuccessTimestamp { get; set; }
        ...
        public bool Equals(AccountStatus input)
        {
            ...
            return
                ...
                (
                    this.SyncTimestamp == input.SyncTimestamp ||
                    this.SyncTimestamp != null &&
                    this.SyncTimestamp.Equals(input.SyncTimestamp)
                ) &&
                (
                    this.SuccessTimestamp == input.SuccessTimestamp ||
                    this.SuccessTimestamp != null &&
                    this.SuccessTimestamp.Equals(input.SuccessTimestamp)
                );
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SyncTimestamp: ").Append(this.SyncTimestamp).Append("\n");
            sb.Append("  SuccessTimestamp: ").Append(this.SuccessTimestamp).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = hashCode * 59 + this.SyncTimestamp.GetHashCode();
                }

                if (this.SuccessTimestamp != null)
                {
                    hashCode = hashCode * 59 + this.SuccessTimestamp.GetHashCode();
                }
