...
namespace Figo.Client.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public class AuthorizationCodeRequest : IEquatable<AuthorizationCodeRequest>, IValidatableObject
    {
        /// <summary>
        ///     Defines GrantType
        /// </summary>
        ...
        /// </summary>
        [JsonConstructor]
        protected AuthorizationCodeRequest()
        {
        }
        ...
        /// <param name="code">The authorization code returned after completing the OAuth flow. (required).</param>
        /// <param name="redirectUri">
        ///     The redirect_uri that was specified [when creating the
        ///     ShieldToken](#operation/createConnectShieldToken). (required).
        /// </param>
        public AuthorizationCodeRequest(GrantTypeEnum grantType = default, string code = default, string redirectUri = default)
        {
            this.GrantType = grantType;
            this.Code = code ?? throw new InvalidDataException("code is a required property for AuthorizationCodeRequest and cannot be null");
            this.RedirectUri =
                redirectUri ?? throw new InvalidDataException("redirectUri is a required property for AuthorizationCodeRequest and cannot be null");
        }
        ...
        /// </summary>
        /// <value>The authorization code returned after completing the OAuth flow.</value>
        [DataMember(Name = "code", EmitDefaultValue = false)]
        public string Code { get; set; }

        /// <summary>
        ///     The redirect_uri that was specified [when creating the
        ///     ShieldToken](#operation/createConnectShieldToken).
        /// </summary>
        /// <value>
        ///     The redirect_uri that was specified [when creating the
        ///     ShieldToken](#operation/createConnectShieldToken).
