...
namespace Figo.Client.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public class Icon : IEquatable<Icon>, IValidatableObject
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="Icon" /> class.
        /// </summary>
        /// <param name="url">URL to provider icon..</param>
        /// <param name="resolutions">resolutions.</param>
        public Icon(object url = default, IconResolutions resolutions = default)
        {
            this.Url = url;
        ...
        /// </summary>
        /// <value>URL to provider icon.</value>
        ...
        public IconResolutions Resolutions { get; set; }

        /// <summary>
        ///     Returns true if Icon instances are equal
        /// </summary>
        /// <param name="input">Instance of Icon to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Icon input)
        {
            if (input == null)
            {
                return false;
            ...
            return
                ...
                (
                    this.Resolutions == input.Resolutions ||
                    this.Resolutions != null &&
                    this.Resolutions.Equals(input.Resolutions)
                );
        }
        ...
        {
            return this.Equals(input as Icon);
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = hashCode * 59 + this.Resolutions.GetHashCode();
                }
