...
namespace Figo.Client.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public class StandingOrders : IEquatable<StandingOrders>, IValidatableObject
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="StandingOrders" /> class.
        /// </summary>
        /// <param name="standingOrders">List of active standing orders..</param>
        public StandingOrders(List<StandingOrder> standingOrders = default)
        {
            this._StandingOrders = standingOrders;
        }

        /// <summary>
        ///     List of active standing orders.
        /// </summary>
        /// <value>List of active standing orders.</value>
        [DataMember(Name = "standing_orders", EmitDefaultValue = false)]
        public List<StandingOrder> _StandingOrders { get; set; }

        /// <summary>
        ///     Returns true if StandingOrders instances are equal
        /// </summary>
        /// <param name="input">Instance of StandingOrders to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StandingOrders input)
        {
            if (input == null)
            {
                return false;
            ...
            return
                this._StandingOrders == input._StandingOrders ||
                this._StandingOrders != null &&
                input._StandingOrders != null &&
                this._StandingOrders.SequenceEqual(input._StandingOrders);
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StandingOrders {\n");
            sb.Append("  _StandingOrders: ").Append(this._StandingOrders).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as StandingOrders);
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = hashCode * 59 + this._StandingOrders.GetHashCode();
                }
