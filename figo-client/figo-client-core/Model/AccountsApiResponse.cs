...
namespace Figo.Client.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public class AccountsApiResponse : IEquatable<AccountsApiResponse>, IValidatableObject
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="AccountsApiResponse" /> class.
        /// </summary>
        /// <param name="accounts">accounts.</param>
        public AccountsApiResponse(List<Account> accounts = default)
        {
        ...
        /// <summary>
        ///     Returns true if AccountsApiResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountsApiResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountsApiResponse input)
        {
            if (input == null)
            {
                return false;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountsApiResponse {\n");
        ...
        {
            return this.Equals(input as AccountsApiResponse);
        }
