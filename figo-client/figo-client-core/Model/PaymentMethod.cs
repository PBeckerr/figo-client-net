...
namespace Figo.Client.Core.Model
{
    ...
    public class PaymentMethod : IEquatable<PaymentMethod>, IValidatableObject
    {
        ...
        /// </param>
        /// <param name="maxPurposeLength">Maximum string length of purpose text..</param>
        /// <param name="supportedTextKeys">List of supported DTA text keys..</param>
        public PaymentMethod(List<string> allowedRecipients = default, bool canBeRecurring = default, bool canBeScheduled = default,
                             int maxPurposeLength = default, List<int> supportedTextKeys = default)
        {
            this.AllowedRecipients = allowedRecipients;
            this.CanBeRecurring = canBeRecurring;
            this.CanBeScheduled = canBeScheduled;
            this.MaxPurposeLength = maxPurposeLength;
            this.SupportedTextKeys = supportedTextKeys;
        }

        /// <summary>
        ///     List of account codes. The payment recipient must be one of these accounts. No restriction applies if this field is
        ///     omitted.
        /// </summary>
        /// <value>
        ///     List of account codes. The payment recipient must be one of these accounts. No restriction applies if this field
        ///     is omitted.
        /// </value>
        [DataMember(Name = "allowed_recipients", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>Indicates whether payments of this type can be recurring. This usually applies for standing orders.</value>
        [DataMember(Name = "can_be_recurring", EmitDefaultValue = false)]
        public bool CanBeRecurring { get; set; }

        /// <summary>
        ///     Indicates whether payments of this type can be scheduled to be executed on a specific date. This usually applies
        ///     for standing orders.
        /// </summary>
        /// <value>
        ///     Indicates whether payments of this type can be scheduled to be executed on a specific date. This usually applies
        ///     for standing orders.
        /// </value>
        [DataMember(Name = "can_be_scheduled", EmitDefaultValue = false)]
        public bool CanBeScheduled { get; set; }

        /// <summary>
        ///     Maximum string length of purpose text.
        /// </summary>
        /// <value>Maximum string length of purpose text.</value>
        [DataMember(Name = "max_purpose_length", EmitDefaultValue = false)]
        public int MaxPurposeLength { get; set; }

        /// <summary>
        ///     List of supported DTA text keys.
        /// </summary>
        /// <value>List of supported DTA text keys.</value>
        [DataMember(Name = "supported_text_keys", EmitDefaultValue = false)]
        public List<int> SupportedTextKeys { get; set; }
        ...
        public bool Equals(PaymentMethod input)
        {
            ...
            return
                (
                    this.AllowedRecipients == input.AllowedRecipients ||
                    this.AllowedRecipients != null &&
                    input.AllowedRecipients != null &&
                    this.AllowedRecipients.SequenceEqual(input.AllowedRecipients)
                ) &&
                (
                    this.CanBeRecurring == input.CanBeRecurring ||
                    this.CanBeRecurring.Equals(input.CanBeRecurring)
                ) &&
                (
                    this.CanBeScheduled == input.CanBeScheduled ||
                    this.CanBeScheduled.Equals(input.CanBeScheduled)
                ) &&
                (
                    this.MaxPurposeLength == input.MaxPurposeLength ||
                    this.MaxPurposeLength.Equals(input.MaxPurposeLength)
                ) &&
                (
                    this.SupportedTextKeys == input.SupportedTextKeys ||
                    this.SupportedTextKeys != null &&
                    input.SupportedTextKeys != null &&
                    this.SupportedTextKeys.SequenceEqual(input.SupportedTextKeys)
                );
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AllowedRecipients: ").Append(this.AllowedRecipients).Append("\n");
            sb.Append("  CanBeRecurring: ").Append(this.CanBeRecurring).Append("\n");
            sb.Append("  CanBeScheduled: ").Append(this.CanBeScheduled).Append("\n");
            sb.Append("  MaxPurposeLength: ").Append(this.MaxPurposeLength).Append("\n");
            sb.Append("  SupportedTextKeys: ").Append(this.SupportedTextKeys).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = hashCode * 59 + this.AllowedRecipients.GetHashCode();
                }

                hashCode = hashCode * 59 + this.CanBeRecurring.GetHashCode();
                hashCode = hashCode * 59 + this.CanBeScheduled.GetHashCode();
                hashCode = hashCode * 59 + this.MaxPurposeLength.GetHashCode();
                if (this.SupportedTextKeys != null)
                {
                    hashCode = hashCode * 59 + this.SupportedTextKeys.GetHashCode();
                }
