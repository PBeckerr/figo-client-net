...
{
    /// <summary>
    ///     ShieldTokenSyncRequest
    /// </summary>
    [DataContract]
    public class ShieldTokenSyncRequest : IEquatable<ShieldTokenSyncRequest>, IValidatableObject
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="ShieldTokenSyncRequest" /> class.
        /// </summary>
        [JsonConstructor]
        protected ShieldTokenSyncRequest()
        {
        }
        ...
        /// </param>
        /// <param name="accounts">List of internal figo account IDs. (required).</param>
        public ShieldTokenSyncRequest(string state = default, string redirectUri = default, List<string> accounts = default)
        {
            this.RedirectUri =
                redirectUri ?? throw new InvalidDataException("redirectUri is a required property for ShieldTokenSyncRequest and cannot be null");
            this.Accounts = accounts ?? throw new InvalidDataException("accounts is a required property for ShieldTokenSyncRequest and cannot be null");
        ...
        /// <summary>
        ///     List of internal figo account IDs.
        /// </summary>
        /// <value>List of internal figo account IDs.</value>
        [DataMember(Name = "accounts", EmitDefaultValue = false)]
        public List<string> Accounts { get; set; }

        /// <summary>
        ///     Returns true if ShieldTokenSyncRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ShieldTokenSyncRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShieldTokenSyncRequest input)
        {
            if (input == null)
            {
                return false;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShieldTokenSyncRequest {\n");
        ...
        {
            return this.Equals(input as ShieldTokenSyncRequest);
        }
