...
namespace Figo.Client.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public class PaymentReceiptAllOf : IEquatable<PaymentReceiptAllOf>, IValidatableObject
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="PaymentReceiptAllOf" /> class.
        /// </summary>
        [JsonConstructor]
        protected PaymentReceiptAllOf()
        {
        }
        ...
        public PaymentReceiptAllOf(Guid id = default, string reference = default, string submittedAt = default)
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for PaymentReceiptAllOf and cannot be null");
            }

            this.Id = id;
            this.Reference = reference ?? throw new InvalidDataException("reference is a required property for PaymentReceiptAllOf and cannot be null");
            this.SubmittedAt = submittedAt ?? throw new InvalidDataException("submittedAt is a required property for PaymentReceiptAllOf and cannot be null");
        }

        /// <summary>
        ///     ID of the created payment.
        /// </summary>
        /// <value>ID of the created payment.</value>
        [DataMember(Name = "id", EmitDefaultValue = false)]
        public Guid Id { get; set; }

        /// <summary>
        ///     The payment end-to-end reference.
        /// </summary>
        /// <value>The payment end-to-end reference.</value>
        [DataMember(Name = "reference", EmitDefaultValue = false)]
        public string Reference { get; set; }

        /// <summary>
        ///     The time at which the payment was submitted to the payment provider.
        /// </summary>
        /// <value>The time at which the payment was submitted to the payment provider.</value>
        [DataMember(Name = "submitted_at", EmitDefaultValue = false)]
        public string SubmittedAt { get; set; }

        /// <summary>
        ///     Returns true if PaymentReceiptAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentReceiptAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentReceiptAllOf input)
        {
            if (input == null)
            {
                return false;
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            var regexReference = new Regex(@"[a-f0-9]{8}", RegexOptions.CultureInvariant);
            if (false == regexReference.Match(this.Reference).Success)
            {
                yield return new ValidationResult("Invalid value for Reference, must match a pattern of " + regexReference, new[] {"Reference"});
            }
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaymentReceiptAllOf {\n");
        ...
        {
            return this.Equals(input as PaymentReceiptAllOf);
        }
