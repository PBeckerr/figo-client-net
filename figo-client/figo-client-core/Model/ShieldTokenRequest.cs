...
namespace Figo.Client.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public class ShieldTokenRequest : IEquatable<ShieldTokenRequest>, IValidatableObject
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="ShieldTokenRequest" /> class.
        /// </summary>
        [JsonConstructor]
        protected ShieldTokenRequest()
        {
        }
        ...
        /// </param>
        public ShieldTokenRequest(string state = default, string redirectUri = default)
        {
            this.RedirectUri = redirectUri ?? throw new InvalidDataException("redirectUri is a required property for ShieldTokenRequest and cannot be null");
        ...
        /// <summary>
        ///     Returns true if ShieldTokenRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ShieldTokenRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShieldTokenRequest input)
        {
            if (input == null)
            {
                return false;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShieldTokenRequest {\n");
        ...
        {
            return this.Equals(input as ShieldTokenRequest);
        }
