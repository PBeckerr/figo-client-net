...
namespace Figo.Client.Core.Model
{
    ...
    public class Error : IEquatable<Error>, IValidatableObject
    {
        ...
        public Error(ErrorError error = default)
        {
            this._Error = error ?? throw new InvalidDataException("error is a required property for Error and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  _Error: ").Append(this._Error).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
