...
{
    /// <summary>
    ///     Mapping of payment types to payment parameters supported by this account.
    /// </summary>
    [DataContract]
    public class AccountSupportedPayments : IEquatable<AccountSupportedPayments>, IValidatableObject
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="AccountSupportedPayments" /> class.
        /// </summary>
        /// <param name="sEPATransfer">sEPATransfer.</param>
        /// <param name="sEPAStandingOrder">sEPAStandingOrder.</param>
        public AccountSupportedPayments(PaymentMethod sEPATransfer = default, PaymentMethod sEPAStandingOrder = default)
        {
        ...
        /// <summary>
        ///     Gets or Sets SEPATransfer
        /// </summary>
        [DataMember(Name = "SEPA transfer", EmitDefaultValue = false)]
        public PaymentMethod SEPATransfer { get; set; }

        /// <summary>
        ///     Gets or Sets SEPAStandingOrder
        /// </summary>
        [DataMember(Name = "SEPA standing order", EmitDefaultValue = false)]
        public PaymentMethod SEPAStandingOrder { get; set; }

        /// <summary>
        ///     Returns true if AccountSupportedPayments instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountSupportedPayments to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountSupportedPayments input)
        {
            if (input == null)
            {
                return false;
            ...
            return
                (
                    this.SEPATransfer == input.SEPATransfer ||
                    this.SEPATransfer != null &&
                    this.SEPATransfer.Equals(input.SEPATransfer)
                ) &&
                (
                    this.SEPAStandingOrder == input.SEPAStandingOrder ||
                    this.SEPAStandingOrder != null &&
                    this.SEPAStandingOrder.Equals(input.SEPAStandingOrder)
                );
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountSupportedPayments {\n");
            sb.Append("  SEPATransfer: ").Append(this.SEPATransfer).Append("\n");
            sb.Append("  SEPAStandingOrder: ").Append(this.SEPAStandingOrder).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as AccountSupportedPayments);
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                var hashCode = 41;
                if (this.SEPATransfer != null)
                {
                    hashCode = hashCode * 59 + this.SEPATransfer.GetHashCode();
                }

                if (this.SEPAStandingOrder != null)
                {
                    hashCode = hashCode * 59 + this.SEPAStandingOrder.GetHashCode();
                }
