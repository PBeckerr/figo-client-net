...
namespace Figo.Client.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public class SimpleError : IEquatable<SimpleError>, IValidatableObject
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="SimpleError" /> class.
        /// </summary>
        [JsonConstructor]
        ...
        ///     Initializes a new instance of the <see cref="SimpleError" /> class.
        /// </summary>
        /// <param name="error">Human readable error description. (required).</param>
        /// <param name="data">Additional data..</param>
        public SimpleError(string error = default, object data = default)
        {
            this.Error = error ?? throw new InvalidDataException("error is a required property for SimpleError and cannot be null");
        ...
        /// <summary>
        ///     Returns true if SimpleError instances are equal
        /// </summary>
        /// <param name="input">Instance of SimpleError to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SimpleError input)
        {
            if (input == null)
            {
                return false;
        ...
        {
            return this.Equals(input as SimpleError);
        }
