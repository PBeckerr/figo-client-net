...
namespace Figo.Client.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public class TANSchemeAdditionalInfo : IEquatable<TANSchemeAdditionalInfo>, IValidatableObject
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="TANSchemeAdditionalInfo" /> class.
        /// </summary>
        /// <param name="hDD">hDD.</param>
        public TANSchemeAdditionalInfo(string hDD = default)
        {
            this.HDD = hDD;
        }
        ...
        /// <summary>
        ///     Returns true if TANSchemeAdditionalInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of TANSchemeAdditionalInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TANSchemeAdditionalInfo input)
        {
            if (input == null)
            {
                return false;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TANSchemeAdditionalInfo {\n");
            sb.Append("  HDD: ").Append(this.HDD).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as TANSchemeAdditionalInfo);
        }
