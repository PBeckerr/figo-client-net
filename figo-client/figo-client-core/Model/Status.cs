...
namespace Figo.Client.Core.Model
{
    ...
    public class Status : IEquatable<Status>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="syncedAt">Time of last synchronization..</param>
        /// <param name="succeededAt">Time of last successful synchronization..</param>
        /// <param name="message">Human-readable error message.</param>
        public Status(string syncedAt = default, string succeededAt = default, string message = default)
        {
        ...
        /// </summary>
        /// <value>Time of last synchronization.</value>
        ...
        /// </summary>
        /// <value>Time of last successful synchronization.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SyncedAt: ").Append(this.SyncedAt).Append("\n");
            sb.Append("  SucceededAt: ").Append(this.SucceededAt).Append("\n");
