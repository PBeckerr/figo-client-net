...
namespace Figo.Client.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public class TransactionCategories : IEquatable<TransactionCategories>, IValidatableObject
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="TransactionCategories" /> class.
        /// </summary>
        /// <param name="parentId">ID of the parent category..</param>
        /// <param name="id">Category ID..</param>
        /// <param name="name">Category name..</param>
        public TransactionCategories(int? parentId = default, int id = default, string name = default)
        {
        ...
        /// </summary>
        /// <value>ID of the parent category.</value>
        ...
        /// <summary>
        ///     Returns true if TransactionCategories instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionCategories to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionCategories input)
        {
            if (input == null)
            {
                return false;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionCategories {\n");
        ...
        {
            return this.Equals(input as TransactionCategories);
        }
