...
{
    /// <summary>
    ///     SecuritiesApiResponse
    /// </summary>
    [DataContract]
    public class SecuritiesApiResponse : IEquatable<SecuritiesApiResponse>, IValidatableObject
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="SecuritiesApiResponse" /> class.
        /// </summary>
        /// <param name="deleted">List of security IDs marked as deleted..</param>
        /// <param name="securities">List of securities..</param>
        public SecuritiesApiResponse(List<string> deleted = default, List<Security> securities = default)
        {
        ...
        /// <summary>
        ///     Returns true if SecuritiesApiResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SecuritiesApiResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SecuritiesApiResponse input)
        {
            if (input == null)
            {
                return false;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SecuritiesApiResponse {\n");
            sb.Append("  Deleted: ").Append(this.Deleted).Append("\n");
            sb.Append("  Securities: ").Append(this.Securities).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as SecuritiesApiResponse);
        }
