...
namespace Figo.Client.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public class TransactionAdditionalInfo : IEquatable<TransactionAdditionalInfo>, IValidatableObject
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="TransactionAdditionalInfo" /> class.
        /// </summary>
        /// <param name="bankReference">*HBCI*: Bank reference or instruction ID, can be filled by the payers bank..</param>
        /// <param name="debitorId">*HBCI*: An identifier of the payer..</param>
        /// <param name="fee">Payed fees..</param>
        /// <param name="grossAmount">Gross amount of the transaction..</param>
        /// <param name="compensationAmount">
        ///     *HBCI*: Sum of reimbursement of out-of-pocket expenses plus processing fee in case of
        ///     a national return / refund debit as well as an optional interest equalization (for SEPA direct debit returns).
        /// </param>
        /// <param name="originalAmount">*HBCI*: Amount of the original direct debit (for SEPA direct debit returns)..</param>
        /// <param name="referencePartyDebitor">*HBCI*: Deviating sender of the transfer..</param>
        /// <param name="referencePartyCreditor">*HBCI*: Deviating receiver of the transfer..</param>
        public TransactionAdditionalInfo(string bankReference = default, string debitorId = default, decimal fee = default, decimal grossAmount = default,
                                         string compensationAmount = default, string originalAmount = default, string referencePartyDebitor = default,
                                         string referencePartyCreditor = default)
        {
            ...
            this.ReferencePartyDebitor = referencePartyDebitor;
            this.ReferencePartyCreditor = referencePartyCreditor;
        }

        /// <summary>
        ///     *HBCI*: Bank reference or instruction ID, can be filled by the payers bank.
        /// </summary>
        /// <value>*HBCI*: Bank reference or instruction ID, can be filled by the payers bank.</value>
        ...
        /// </summary>
        /// <value>*HBCI*: An identifier of the payer.</value>
        [DataMember(Name = "debitor_id", EmitDefaultValue = false)]
        public string DebitorId { get; set; }

        /// <summary>
        ///     Payed fees.
        /// </summary>
        /// <value>Payed fees.</value>
        ...
        /// </summary>
        /// <value>Gross amount of the transaction.</value>
        [DataMember(Name = "gross_amount", EmitDefaultValue = false)]
        public decimal GrossAmount { get; set; }

        /// <summary>
        ///     *HBCI*: Sum of reimbursement of out-of-pocket expenses plus processing fee in case of a national return / refund
        ///     debit as well as an optional interest equalization (for SEPA direct debit returns)
        /// </summary>
        /// <value>
        ///     *HBCI*: Sum of reimbursement of out-of-pocket expenses plus processing fee in case of a national return / refund
        ///     debit as well as an optional interest equalization (for SEPA direct debit returns)
        /// </value>
        [DataMember(Name = "compensation_amount", EmitDefaultValue = false)]
        public string CompensationAmount { get; set; }

        /// <summary>
        ///     *HBCI*: Amount of the original direct debit (for SEPA direct debit returns).
        /// </summary>
        /// <value>*HBCI*: Amount of the original direct debit (for SEPA direct debit returns).</value>
        ...
        /// </summary>
        /// <value>*HBCI*: Deviating sender of the transfer.</value>
        [DataMember(Name = "reference_party_debitor", EmitDefaultValue = false)]
        public string ReferencePartyDebitor { get; set; }

        /// <summary>
        ///     *HBCI*: Deviating receiver of the transfer.
        /// </summary>
        /// <value>*HBCI*: Deviating receiver of the transfer.</value>
        [DataMember(Name = "reference_party_creditor", EmitDefaultValue = false)]
        public string ReferencePartyCreditor { get; set; }

        /// <summary>
        ///     Returns true if TransactionAdditionalInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionAdditionalInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionAdditionalInfo input)
        {
            if (input == null)
            {
                return false;
            ...
            return
                ...
                (
                    this.DebitorId == input.DebitorId ||
                    this.DebitorId != null &&
                    this.DebitorId.Equals(input.DebitorId)
                ) &&
                (
                    this.Fee == input.Fee ||
                ...
                (
                    this.CompensationAmount == input.CompensationAmount ||
                    this.CompensationAmount != null &&
                    this.CompensationAmount.Equals(input.CompensationAmount)
                ) &&
                (
                ...
                (
                    this.ReferencePartyDebitor == input.ReferencePartyDebitor ||
                    this.ReferencePartyDebitor != null &&
                    this.ReferencePartyDebitor.Equals(input.ReferencePartyDebitor)
                ) &&
                (
                    this.ReferencePartyCreditor == input.ReferencePartyCreditor ||
                    this.ReferencePartyCreditor != null &&
                    this.ReferencePartyCreditor.Equals(input.ReferencePartyCreditor)
                );
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionAdditionalInfo {\n");
            sb.Append("  BankReference: ").Append(this.BankReference).Append("\n");
            sb.Append("  DebitorId: ").Append(this.DebitorId).Append("\n");
            sb.Append("  Fee: ").Append(this.Fee).Append("\n");
            sb.Append("  GrossAmount: ").Append(this.GrossAmount).Append("\n");
            sb.Append("  CompensationAmount: ").Append(this.CompensationAmount).Append("\n");
            sb.Append("  OriginalAmount: ").Append(this.OriginalAmount).Append("\n");
            sb.Append("  ReferencePartyDebitor: ").Append(this.ReferencePartyDebitor).Append("\n");
            sb.Append("  ReferencePartyCreditor: ").Append(this.ReferencePartyCreditor).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as TransactionAdditionalInfo);
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.DebitorId != null)
                {
                    hashCode = hashCode * 59 + this.DebitorId.GetHashCode();
                }
                ...
                {
                    hashCode = hashCode * 59 + this.CompensationAmount.GetHashCode();
                }
                ...
                if (this.ReferencePartyDebitor != null)
                {
                    hashCode = hashCode * 59 + this.ReferencePartyDebitor.GetHashCode();
                }

                if (this.ReferencePartyCreditor != null)
                {
                    hashCode = hashCode * 59 + this.ReferencePartyCreditor.GetHashCode();
                }
