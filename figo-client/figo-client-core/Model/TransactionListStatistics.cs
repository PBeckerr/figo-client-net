...
namespace Figo.Client.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public class TransactionListStatistics : IEquatable<TransactionListStatistics>, IValidatableObject
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="TransactionListStatistics" /> class.
        /// </summary>
        /// <param name="depositSum">Sum of deposits.</param>
        /// <param name="depositMax">Maximum deposit amount.</param>
        /// <param name="expenseMax">Maximum expense amount.</param>
        /// <param name="expenseSum">Sum of expenses.</param>
        public TransactionListStatistics(decimal depositSum = default, decimal depositMax = default, decimal expenseMax = default, decimal expenseSum = default)
        {
        ...
        ///     Sum of deposits
        /// </summary>
        /// <value>Sum of deposits</value>
        [DataMember(Name = "deposit_sum", EmitDefaultValue = false)]
        public decimal DepositSum { get; set; }

        /// <summary>
        ///     Maximum deposit amount
        /// </summary>
        /// <value>Maximum deposit amount</value>
        [DataMember(Name = "deposit_max", EmitDefaultValue = false)]
        public decimal DepositMax { get; set; }

        /// <summary>
        ///     Maximum expense amount
        /// </summary>
        /// <value>Maximum expense amount</value>
        [DataMember(Name = "expense_max", EmitDefaultValue = false)]
        public decimal ExpenseMax { get; set; }

        /// <summary>
        ///     Sum of expenses
        /// </summary>
        /// <value>Sum of expenses</value>
        [DataMember(Name = "expense_sum", EmitDefaultValue = false)]
        public decimal ExpenseSum { get; set; }

        /// <summary>
        ///     Returns true if TransactionListStatistics instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionListStatistics to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionListStatistics input)
        {
            if (input == null)
            {
                return false;
            ...
            return
                (
                    this.DepositSum == input.DepositSum ||
                    this.DepositSum.Equals(input.DepositSum)
                ) &&
                (
                    this.DepositMax == input.DepositMax ||
                    this.DepositMax.Equals(input.DepositMax)
                ) &&
                (
                    this.ExpenseMax == input.ExpenseMax ||
                    this.ExpenseMax.Equals(input.ExpenseMax)
                ) &&
                (
                    this.ExpenseSum == input.ExpenseSum ||
                    this.ExpenseSum.Equals(input.ExpenseSum)
                );
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionListStatistics {\n");
            sb.Append("  DepositSum: ").Append(this.DepositSum).Append("\n");
            sb.Append("  DepositMax: ").Append(this.DepositMax).Append("\n");
            sb.Append("  ExpenseMax: ").Append(this.ExpenseMax).Append("\n");
            sb.Append("  ExpenseSum: ").Append(this.ExpenseSum).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as TransactionListStatistics);
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                var hashCode = 41;
                hashCode = hashCode * 59 + this.DepositSum.GetHashCode();
                hashCode = hashCode * 59 + this.DepositMax.GetHashCode();
                hashCode = hashCode * 59 + this.ExpenseMax.GetHashCode();
                hashCode = hashCode * 59 + this.ExpenseSum.GetHashCode();
                return hashCode;
            }
        }
    }
