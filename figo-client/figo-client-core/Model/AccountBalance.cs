...
namespace Figo.Client.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public class AccountBalance : IEquatable<AccountBalance>, IValidatableObject
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="AccountBalance" /> class.
        /// </summary>
        /// <param name="balance">Account balance. This response parameter will be omitted if the balance is not yet known..</param>
        ...
        public AccountBalance(decimal balance = default, string balanceDate = default, Status status = default)
        {
        ...
        /// </summary>
        /// <value>Account balance. This response parameter will be omitted if the balance is not yet known.</value>
        [DataMember(Name = "balance", EmitDefaultValue = false)]
        public decimal Balance { get; set; }

        /// <summary>
        ///     Bank server timestamp of balance. This response parameter will be omitted if the balance is not yet
        ///     known.
        /// </summary>
        /// <value>
        ///     Bank server timestamp of balance. This response parameter will be omitted if the balance is not yet
        ///     known.
        /// </value>
        [DataMember(Name = "balance_date", EmitDefaultValue = false)]
