...
namespace Figo.Client.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public class ErrorError : IEquatable<ErrorError>, IValidatableObject
    {
        /// <summary>
        ...
        public enum GroupEnum
        {
            ...
            /// </summary>
            [EnumMember(Value = "Client")] Client = 1,

            /// <summary>
            ///     Enum User for value: User
            /// </summary>
            [EnumMember(Value = "User")] User = 2,

            /// <summary>
            ///     Enum Bank for value: Bank
            /// </summary>
            [EnumMember(Value = "Bank")] Bank = 3,

            /// <summary>
            ///     Enum Figo for value: figo
            /// </summary>
            [EnumMember(Value = "figo")] Figo = 4
        }
