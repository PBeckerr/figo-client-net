...
namespace Figo.Client.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public class ShieldTokenCreated : IEquatable<ShieldTokenCreated>, IValidatableObject
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="ShieldTokenCreated" /> class.
        /// </summary>
        [JsonConstructor]
        protected ShieldTokenCreated()
        {
        }
        ...
        /// </summary>
        /// <param name="location">
        ///     The location of the RegShield UI to which the user should be directed. The location includes the
        ///     ShieldToken as query parameter. (required).
        /// </param>
        /// <param name="id">ID of the created ShieldToken (required).</param>
        public ShieldTokenCreated(string location = default, Guid id = default)
        {
            this.Location = location ?? throw new InvalidDataException("location is a required property for ShieldTokenCreated and cannot be null");

            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for ShieldTokenCreated and cannot be null");
            }
        ...
        /// <summary>
        ///     The location of the RegShield UI to which the user should be directed. The location includes the ShieldToken as
        ///     query parameter.
        /// </summary>
        /// <value>
        ///     The location of the RegShield UI to which the user should be directed. The location includes the ShieldToken as
        ...
        /// <summary>
        ///     ID of the created ShieldToken
        /// </summary>
        /// <value>ID of the created ShieldToken</value>
        [DataMember(Name = "id", EmitDefaultValue = false)]
        public Guid Id { get; set; }

        /// <summary>
        ///     Returns true if ShieldTokenCreated instances are equal
        /// </summary>
        /// <param name="input">Instance of ShieldTokenCreated to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShieldTokenCreated input)
        {
            if (input == null)
            {
                return false;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShieldTokenCreated {\n");
        ...
        {
            return this.Equals(input as ShieldTokenCreated);
        }
