...
namespace Figo.Client.Core.Model
{
    ...
    public class AccessToken : IEquatable<AccessToken>, IValidatableObject
    {
        ...
        ///     variable length and it is highly advised to not limit the size of the database field in your storage backend. If
        ///     you have to specify a size for the corresponding database field a choice of at least 2048 bytes is highly
        ///     recommended..
        /// </param>
        /// <param name="expiresIn">The lifetime in seconds of the access token..</param>
        /// <param name="refreshToken">
        ///     The refresh token for the current user as JSON Web Token according to RFC7519. It has a
        ///     variable length and it is highly advised to not limit the size of the database field in your storage backend. If
        ///     you have to specify a size for the corresponding database field a choice of at least 2048 bytes is highly
        ///     recommended..
        /// </param>
        /// <param name="tokenType">The type of the issued token..</param>
        public AccessToken(string accessToken = default, int expiresIn = default, string refreshToken = default, TokenTypeEnum? tokenType = default)
        {
        ...
        /// <summary>
        ///     The access token for the current user as JSON Web Token according to RFC7519. It has a variable length and it is
        ///     highly advised to not limit the size of the database field in your storage backend. If you have to specify a size
        ///     for the corresponding database field a choice of at least 2048 bytes is highly recommended.
        /// </summary>
        /// <value>
        ///     The access token for the current user as JSON Web Token according to RFC7519. It has a variable length and it is
        ///     highly advised to not limit the size of the database field in your storage backend. If you have to specify a size
        ...
        /// <summary>
        ///     The refresh token for the current user as JSON Web Token according to RFC7519. It has a variable length and it is
        ///     highly advised to not limit the size of the database field in your storage backend. If you have to specify a size
        ///     for the corresponding database field a choice of at least 2048 bytes is highly recommended.
        /// </summary>
        /// <value>
        ///     The refresh token for the current user as JSON Web Token according to RFC7519. It has a variable length and it
        ///     is highly advised to not limit the size of the database field in your storage backend. If you have to specify a
        ...
        public override string ToString()
        {
            ...
            sb.Append("  _AccessToken: ").Append(this._AccessToken).Append("\n");
