...
namespace Figo.Client.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public class Accounts : IEquatable<Accounts>, IValidatableObject
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="Accounts" /> class.
        /// </summary>
        /// <param name="accounts">accounts.</param>
        public Accounts(List<Account> accounts = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("  _Accounts: ").Append(this._Accounts).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
