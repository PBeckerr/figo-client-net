...
namespace Figo.Client.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public class RefreshTokenRequest : IEquatable<RefreshTokenRequest>, IValidatableObject
    {
        /// <summary>
        ///     Defines GrantType
        /// </summary>
        ...
        public enum GrantTypeEnum
        {
            ...
            /// </summary>
            [EnumMember(Value = "refresh_token")] Refreshtoken = 1
        }
        ...
        /// <summary>
        ///     A refresh token that may be used to request new access tokens. Refresh tokens remain valid for a maximum of 90
        ///     days.
        /// </summary>
        /// <value>
        ///     A refresh token that may be used to request new access tokens. Refresh tokens remain valid for a maximum of 90
        ...
        /// <summary>
        ///     A space delimited set of requested permissions. The requested permissions can be narrower but not broader than the
        ///     permissions agreed during application registration. If this parameter is omitted, the permissions agreed during
        ///     application registration are used in place.
        /// </summary>
        /// <value>
        ///     A space delimited set of requested permissions. The requested permissions can be narrower but not broader than
        ///     the permissions agreed during application registration. If this parameter is omitted, the permissions agreed during
        ///     application registration are used in place.
        /// </value>
