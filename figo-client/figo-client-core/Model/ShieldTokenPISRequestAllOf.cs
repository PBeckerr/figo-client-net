...
{
    /// <summary>
    ///     ShieldTokenPISRequestAllOf
    /// </summary>
    [DataContract]
    public class ShieldTokenPISRequestAllOf : IEquatable<ShieldTokenPISRequestAllOf>, IValidatableObject
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="ShieldTokenPISRequestAllOf" /> class.
        /// </summary>
        [JsonConstructor]
        protected ShieldTokenPISRequestAllOf()
        {
        }
        ...
        public ShieldTokenPISRequestAllOf(string accountId = default, Payment payment = default, string tanSchemeId = default)
        {
            this.AccountId = accountId ?? throw new InvalidDataException("accountId is a required property for ShieldTokenPISRequestAllOf and cannot be null");
            this.Payment = payment ?? throw new InvalidDataException("payment is a required property for ShieldTokenPISRequestAllOf and cannot be null");
            this.TanSchemeId =
                tanSchemeId ?? throw new InvalidDataException("tanSchemeId is a required property for ShieldTokenPISRequestAllOf and cannot be null");
        }
        ...
        /// <summary>
        ///     Returns true if ShieldTokenPISRequestAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ShieldTokenPISRequestAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShieldTokenPISRequestAllOf input)
        {
            if (input == null)
            {
                return false;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShieldTokenPISRequestAllOf {\n");
        ...
        {
            return this.Equals(input as ShieldTokenPISRequestAllOf);
        }
