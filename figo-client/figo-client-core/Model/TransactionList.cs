...
namespace Figo.Client.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public class TransactionList : IEquatable<TransactionList>, IValidatableObject
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="TransactionList" /> class.
        /// </summary>
        /// <param name="deleted">List of transaction IDs marked as deleted..</param>
        /// <param name="transactions">List of transactions..</param>
        /// <param name="status">status.</param>
        /// <param name="statistics">statistics.</param>
        public TransactionList(List<string> deleted = default, List<Transaction> transactions = default, Status status = default,
                               TransactionListStatistics statistics = default)
        {
        ...
        /// <summary>
        ///     List of transaction IDs marked as deleted.
        /// </summary>
        /// <value>List of transaction IDs marked as deleted.</value>
        ...
        public TransactionListStatistics Statistics { get; set; }
