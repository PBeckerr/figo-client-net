...
namespace Figo.Client.Core.Api
{
    ...
    public interface IVerificationApiSync : IApiAccessor
    {
        ...
        /// </summary>
        /// <remarks>
        ///     Get a payment receipt that indicates if the user has initiated the payment identified by payment-id.
        ///     This call might return a 404 as long as the user is still being guided through the flow but has not yet
        ///     executed the payment at the bank. The same holds true if the user aborts the flow.
        /// </remarks>
        /// <exception cref="ApiException">Thrown when fails to make API call</exception>
        /// <param name="paymentId"></param>
        /// <returns>PaymentReceipt</returns>
        PaymentReceipt GetPaymentReceipt(string paymentId);
        ...
        /// <exception cref="ApiException">Thrown when fails to make API call</exception>
        /// <param name="paymentId"></param>
        /// <returns>ApiResponse of PaymentReceipt</returns>
        ApiResponse<PaymentReceipt> GetPaymentReceiptWithHttpInfo(string paymentId);
    ...
    public interface IVerificationApiAsync : IApiAccessor
    {
        ...
        /// <exception cref="ApiException">Thrown when fails to make API call</exception>
        /// <param name="paymentId"></param>
        /// <returns>Task of PaymentReceipt</returns>
        Task<PaymentReceipt> GetPaymentReceiptAsync(string paymentId);
        ...
        /// <exception cref="ApiException">Thrown when fails to make API call</exception>
        /// <param name="paymentId"></param>
        /// <returns>Task of ApiResponse (PaymentReceipt)</returns>
        Task<ApiResponse<PaymentReceipt>> GetPaymentReceiptAsyncWithHttpInfo(string paymentId);
    ...
    public class VerificationApi : IVerificationApi
    {
        ...
        /// </summary>
        /// <returns></returns>
        public VerificationApi(string basePath, ILogger logger = null)
        {
        ...
        /// <returns></returns>
        public VerificationApi(Configuration configuration, ILogger logger = null)
        {
        ...
        public VerificationApi(ISynchronousClient client, IAsynchronousClient asyncClient, IReadableConfiguration configuration)
        {
        ...
        /// <param name="paymentId"></param>
        /// <returns>PaymentReceipt</returns>
        public PaymentReceipt GetPaymentReceipt(string paymentId)
        {
            var localVarResponse = this.GetPaymentReceiptWithHttpInfo(paymentId);
        ...
        /// <param name="paymentId"></param>
        /// <returns>ApiResponse of PaymentReceipt</returns>
        public ApiResponse<PaymentReceipt> GetPaymentReceiptWithHttpInfo(string paymentId)
        {
            // verify the required parameter 'paymentId' is set
            if (paymentId == null)
            {
                throw new ApiException(400, "Missing required parameter 'paymentId' when calling VerificationApi->GetPaymentReceipt");
            }
            ...
            if (paymentId != null)
            {
                requestOptions.PathParameters.Add("payment-id", ClientUtils.ParameterToString(paymentId)); // path parameter
            }
            ...
            var response = this.Client.Get<PaymentReceipt>("/v1/payments/{payment-id}", requestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                var exception = this.ExceptionFactory("GetPaymentReceipt", response);
                if (exception != null)
                {
                    throw exception;
                }
        ...
        /// <param name="paymentId"></param>
        /// <returns>Task of PaymentReceipt</returns>
        public async Task<PaymentReceipt> GetPaymentReceiptAsync(string paymentId)
        {
            var localVarResponse = await this.GetPaymentReceiptAsyncWithHttpInfo(paymentId).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="paymentId"></param>
        /// <returns>Task of ApiResponse (PaymentReceipt)</returns>
        public async Task<ApiResponse<PaymentReceipt>> GetPaymentReceiptAsyncWithHttpInfo(string paymentId)
        {
            // verify the required parameter 'paymentId' is set
            if (paymentId == null)
            {
            ...
            var response = await this.AsynchronousClient.GetAsync<PaymentReceipt>("/v1/payments/{payment-id}", requestOptions, this.Configuration)
